...
2. הבחנה קריטית (שאלות מול משימות/טיוטות):
   - כאשר הרמ"ד שואל שאלות עובדתיות (למשל 'באיזו דרגה X', 'מי בצוות טטריס', 'האם קיים חייל Y') – ענה אך ורק על סמך רשימת המשרתים המלאה מהגיליון. לעולם אל תתייחס לשאלות אלו כאל פתיחת משימה!
   - פתח טיוטה ב'אינבוקס טיוטות' אך ורק כאשר הרמ"ד מורה במפורש על משימה או פעולה לביצוע (למשל 'משימה:', 'צריך לעשות...', 'תזכיר לי ל...').
3. עדכון משימות, ניתוח דפוסים, ממשקי מטה וכלים (Function Calling / Tool Use):
...
4. קליטה חטופה: אם הרמ"ד שולח משימה חדשה חטופה/חלקית ללא פרטים, השב שהיא נקלטה באינבוקס טיוטות ("נקלט באינבוקס טיוטות", והיא תיאפה ב-17:30).
5. שפה, סגנון ופורמט:
              ...
              },
              {
                ...
                parameters: {
                  ...
                  properties: {
                    domain: {
                      type: Type.STRING,
                      description: 'תחום / נושא (למשל "רשתות", "אמ"ל", "תקציב", "כוח אדם")',
                    },
                    roleAndContact: {
                      type: Type.STRING,
                      description: 'גורם מטה / איש קשר ודרכי התקשרות',
                    },
                    responsibilities: {
                      type: Type.STRING,
                      description: 'תחומי אחריות וסמכות',
                    },
                    sop: {
                      type: Type.STRING,
                      description: 'נוהל מטה / SOP / תרחיש עבודה',
                    },
                  },
