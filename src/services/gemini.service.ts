        ...
        tools: [
          {
            functionDeclarations: [
              {
                name: 'create_task',
                description: 'יוצרת משימה חדשה ישירות בגיליון משימות_ותגב עם כותרת, צוות, תג"ב ועדיפות.',
                parameters: {
                  type: Type.OBJECT,
                  properties: {
                    title: {
                    ...
                    tgb: {
                      type: Type.STRING,
                      description: 'תג"ב יעד בפורמט YYYY-MM-DD',
                    },
                    priority: {
                      type: Type.STRING,
                    ...
                    effort: {
                      type: Type.STRING,
                      description: 'רמת קשב וזמן עבודה (למשל "קשב עמוק [חצי יום+]", "קשב בינוני [שעה-שעתיים]")',
                    },
                    contacts: {
                      type: Type.STRING,
                      description: 'אנשי קשר וגורמי חוץ',
                    },
                    notes: {
                      type: Type.STRING,
                      description: 'הערות ודגשים נוספים',
                    },
                  },
