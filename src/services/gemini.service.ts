...
export class GeminiService {
  ...
  private fallbackModels: string[] = ['gemini-pro-latest', 'gemini-3.1-pro-preview', 'gemini-2.5-flash'];
...
2. עדכון משימות, ניתוח דפוסים וכלים (Function Calling / Tool Use):
   - אם הרמ"ד מבקש לסגור משימה / לסמן כמבוצעת (גם עבור מספר משימות במקביל) -> הפעל את הכלי close_task(taskId) לכל משימה. המשימה תיסגר ותועבר לארכיון_משימות.
        ...
        tools: [
          {
            functionDeclarations: [
              {
                name: 'close_task',
                description: 'משנה את סטטוס המשימה ל-"הושלם" ומעבירה מגיליון משימות_ותגב לגיליון ארכיון_משימות.',
                parameters: {
                  type: Type.OBJECT,
                  properties: {
                    taskId: {
